...
from ppo_discrete import VecPyTorch, Agent, linear_schedule
...
if __name__ == "__main__":
    ...
    if not args.all_in_one:
        # discriminator  should be learned
        ...
        dataset = ImageDataset(buffer_size=args.buffer_size, height=height, width=width, transform=transform)
        dataset.clean_data()
